---
name: "source-command-maak-offerte"
description: "Migrated source command `maak-offerte`"
---

# source-command-maak-offerte

Use this skill when the user asks to run the migrated source command `maak-offerte`.
